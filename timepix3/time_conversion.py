...
#            information on what that means in practice. The functions in this file do not take 
...
sys_clk  = 40e6      # system clock speed in Hz (25ns resolution)
ftoa_clk = 640e6     # ftoa clock speed in Hz (1.56 ns resolution)
epoch    = 0         # unknown, really! (see comment 2. above)
...
def time_to_toa(time, clk_speed=sys_clk, epoch=epoch):
...
def toa_to_time(toa, clk_speed=sys_clk, epoch=epoch):
...
def time_to_ftoa(time, clk_speed_1=sys_clk, clk_speed_2=ftoa_clk, epoch=epoch):
...
def ftoa_and_toa_to_time(ftoa, toa, clk_speed_1=sys_clk,clk_speed_2=ftoa_clk, epoch=epoch):
...
def time_to_tot(start, stop, clk_speed=sys_clk, epoch=epoch):
...
def tot_and_toa_to_time(tot, toa, ftoa=0, clk_speed_1=sys_clk, clk_speed_2=ftoa_clk, epoch=epoch):
